...
length_val = params[2]
print ('nval: ', nesting_val, length_val)
...
if script_path() == "data_test_nesting_length.lua" then
  ...
  print("\n__________________\n")
  torch.save(lfs.currentdir()..'/test_nesting_length/input_nesting_'..tostring(nesting_val)..'_length_'..tostring(length_val)..'.dat', training_val)
  torch.save(lfs.currentdir()..'/test_nesting_length/target_nesting_'..tostring(nesting_val)..'_length_'..tostring(length_val)..'.dat', target_val)
end
